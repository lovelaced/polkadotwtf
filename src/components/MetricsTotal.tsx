...
const metricDescriptions: Record<string, string> = {
  ...
  gas: 'Polkadot has a two-dimensional gas system. One full block is 60M gas equivalent (very conservative estimate, this value is likely to change in the future with further benchmarking) according to EVM configuration on mainnet.',
